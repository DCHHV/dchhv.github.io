...
You might be wondering about that top, antenna area now. For this last part you will be building the IR transmitter and receivers. You are provided, 3.3V, ground, IR TX pin, and IR RX pin.


| Designator(s) | Part | Type |
|---:|---|---|
| D8 | TSAL6200 IR LED | Through hole |
| Q1 | 2N3904 n-channel mosfet | Through hole |
| Q2 | TEFT4300 IR phototransistor | Through hole |
| R90 | 1k Ohm resistors | Through hole |
| R91 | 100 Ohm resistor | Through hole |
| R92 | 47k Ohm resistor | Through hole |
