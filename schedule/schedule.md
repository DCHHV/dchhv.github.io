...
[Badgelife]() is alive and well this year at DEF CON. If you are looking for advice on creating, hacking, augmenting or fixing badges, most creators wander into HHV from time to time. They and the HHV volunteers will be around to help and answer questions about the community and how to get involved. HHV is not a place that sells badges, or a place to pick up purchased badges, but a place that welcomes the curious. Come hang out and learn more at the info booth, or join the [Badgemakers Discord](https://discord.gg/SPHmVzbDXN)
